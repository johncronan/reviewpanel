# Generated by Django 4.0.3 on 2022-03-11 22:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('x', models.DecimalField(decimal_places=3, default=0, max_digits=7)),
                ('y', models.DecimalField(decimal_places=3, default=0, max_digits=7)),
                ('w', models.DecimalField(decimal_places=3, default=100, max_digits=7)),
                ('h', models.DecimalField(blank=True, decimal_places=3, max_digits=7, null=True)),
